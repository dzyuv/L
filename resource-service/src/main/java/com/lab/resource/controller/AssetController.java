...
public class AssetController {
    ...
    @GetMapping("/admin/assets/purchases") public ApiResponse<?> purchases(HttpServletRequest request) { return ok(service.listPurchases(request), request); }
    ...
    @GetMapping("/admin/assets/{id:\\d+}") public ApiResponse<?> asset(@PathVariable("id") Long id, HttpServletRequest request) { return ok(service.getAsset(id, request), request); }
    ...
    @PutMapping("/admin/assets/{id:\\d+}") public ApiResponse<?> updateAsset(@PathVariable("id") Long id, @Valid @RequestBody AssetRequest body, HttpServletRequest request) { return ok(service.updateAsset(id, body, request), request); }
    @PutMapping("/admin/assets/{id:\\d+}/status") public ApiResponse<?> status(@PathVariable("id") Long id, @Valid @RequestBody StatusRequest body, HttpServletRequest request) { return ok(service.updateStatus(id, body, request), request); }
    @PostMapping("/admin/assets/{id:\\d+}/assign") public ApiResponse<?> assign(@PathVariable("id") Long id, @Valid @RequestBody AssignRequest body, HttpServletRequest request) { return ok(service.assign(id, body, request), request); }
    @GetMapping("/admin/assets/{id:\\d+}/history") public ApiResponse<?> history(@PathVariable("id") Long id, HttpServletRequest request) { return ok(service.history(id, request), request); }
