...
public class ResourceController {
    ...
    @PutMapping("/admin/resource-types/{id}") public ApiResponse<?> updateType(@PathVariable("id") Long id, @Valid @RequestBody TypeUpdateRequest body, HttpServletRequest request) { return ok(service.updateType(id, body, request), request); }
    @DeleteMapping("/admin/resource-types/{id}") public ApiResponse<?> deleteType(@PathVariable("id") Long id, HttpServletRequest request) { service.deleteType(id, request); return ok(Map.of("deleted", true), request); }
