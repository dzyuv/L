...
public class ClosureController {
    ...
    @GetMapping public ApiResponse<?> list(@PathVariable("resourceId") Long resourceId, HttpServletRequest request) { return ok(service.list(resourceId, request), request); }
    @PostMapping public ApiResponse<?> create(@PathVariable("resourceId") Long resourceId, @Valid @RequestBody ResourceClosureRequest body, HttpServletRequest request) { return ok(service.create(resourceId, body, request), request); }
